...
//        rubricService.save(rubric3);
        ...
        Author authorFound = authorService.findById(2);
        Rubric rubricFound = rubricService.findById(7);

        Author authorFound2 = authorService.findById(10);
        Rubric rubricFound2 = rubricService.findById(20);

        Author authorFound3 = authorService.findById(15);
        Rubric rubricFound3 = rubricService.findById(21);
